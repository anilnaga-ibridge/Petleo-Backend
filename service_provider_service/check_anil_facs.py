...
def check_anil_facilities():
    try:
        provider = ServiceProvider.objects.get(verified_user__email='anil.naga@ibridge.digital')
        ...
        print("Anil Naga provider not found")

if __name__ == "__main__":
    check_anil_facilities()

...
def test_gopi_menu():
    print("--- Testing Menu for gopi@gmail.com ---")
    try:
        provider = ServiceProvider.objects.get(verified_user__email='gopi@gmail.com')
        user = provider.verified_user
    except ServiceProvider.DoesNotExist:
        print("Gopi not found")
        return
    ...
    menu = _build_permission_tree(user, request=request)

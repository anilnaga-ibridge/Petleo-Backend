...
#         try:
#             res = requests.get(f"{SUPERADMIN_DOCS_PUBLIC}?target={target}", timeout=5)
...
#                 return Response({"definitions": docs})
#         except:
#             pass
